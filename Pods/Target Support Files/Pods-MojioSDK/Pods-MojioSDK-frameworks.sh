...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "Pods-MojioSDK/Alamofire.framework"
  install_framework "Pods-MojioSDK/KeychainSwift.framework"
  install_framework "Pods-MojioSDK/OHHTTPStubs.framework"
