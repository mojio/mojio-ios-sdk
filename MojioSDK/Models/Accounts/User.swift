...
public struct PrivacyRequest: Codable {
    ...
    public let privacyRequest: String
    
    public enum CodingKeys: String, CodingKey, CompoundWordStyle {
        case privacyRequest = "PrivacyRequest"
    }
    ...
    public init(from decoder: Decoder) throws {
        ...
        do {
            self.privacyRequest = try container.decodeIgnoringCase(String.self, forKey: CodingKeys.privacyRequest)
        }
        catch let error {
            debugPrint(error)
            throw error
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(self.privacyRequest, forKey: .privacyRequest)
    }
    
    public init(for action: String) {
        self.privacyRequest = action
    }
}
