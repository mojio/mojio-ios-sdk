...
public typealias ProperAccelerationModel = DeviceMeasurement

public struct ProperAcceleration: ProperAccelerationModel {
    
    public typealias U = AccelerometerUnit
