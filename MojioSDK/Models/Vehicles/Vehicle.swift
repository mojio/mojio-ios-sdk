...
public struct Vehicle: VehicleModel {
    ...
    public init(from decoder: Decoder) throws {
        do {
            ...
            self.licensePlate = try container.decodeIfPresentIgnoringCase(String.self, forKey: .licensePlate)
            self.vin = try container.decodeIfPresentIgnoringCase(String.self, forKey: .vin)
            self.detectedVIN = try container.decodeIfPresentIgnoringCase(String.self, forKey: .detectedVIN)
            self.overrideVIN = try container.decodeIfPresentIgnoringCase(String.self, forKey: .overrideVIN)
            self.mojioId = try container.decodeIfPresentIgnoringCase(String.self, forKey: .mojioId)
            self.compatDetails = try container.decodeIfPresentIgnoringCase(CompatibilityDetails.self, forKey: .compatDetails)
            self.currentTrip = try container.decodeIfPresentIgnoringCase(String.self, forKey: .currentTrip)
            self.milStatus = try container.decodeIfPresentIgnoringCase(Bool.self, forKey: .milStatus) ?? false
            self.diagnosticCodes = try container.decodeIfPresentIgnoringCase([DiagnosticCode].self, forKey: .diagnosticCodes) ?? []
            self.lastContactTime = try container.decodeIfPresentIgnoringCase(String.self, forKey: .lastContactTime).flatMap { $0.dateFromISO }
            self.accelerometer = try container.decodeIfPresentIgnoringCase(Accelerometer.self, forKey: .accelerometer)
            self.acceleration = try container.decodeIfPresentIgnoringCase(Acceleration.self, forKey: .acceleration)
            self.deceleration = try container.decodeIfPresentIgnoringCase(Acceleration.self, forKey: .deceleration)
            
            self.speed = try container.decodeIfPresentIgnoringCase(Speed.self, forKey: .speed)
            self.odometer = try container.decodeIfPresentIgnoringCase(Odometer.self, forKey: .odometer)
            self.virtualOdometer = try container.decodeIfPresentIgnoringCase(Odometer.self, forKey: .virtualOdometer)
            self.rpm = try container.decodeIfPresentIgnoringCase(RPM.self, forKey: .rpm)
            self.fuelEfficiency = try container.decodeIfPresentIgnoringCase(FuelEfficiency.self, forKey: .fuelEfficiency)
            self.fuelEfficiencyCalculationMethod = try container.decodeIfPresentIgnoringCase(FuelEfficiencyCalculationMethod.self, forKey: .fuelEfficiencyCalculationMethod)
            self.fuelLevel = try container.decodeIfPresentIgnoringCase(FuelLevel.self, forKey: .fuelLevel)
            self.fuelVolume = try container.decodeIfPresentIgnoringCase(FuelVolume.self, forKey: .fuelVolume)
            self.fuelType = try container.decodeIfPresentIgnoringCase(FuelType.self, forKey: .fuelType)
            self.gatewayTime = try container.decodeIfPresentIgnoringCase(String.self, forKey: .gatewayTime).flatMap { $0.dateFromISO }
            self.harshEventState = try container.decodeIfPresentIgnoringCase(HarshEventState.self, forKey: .harshEventState)
            self.idleState = try container.decodeIfPresentIgnoringCase(IdleState.self, forKey: .idleState)
            self.ignitionState = try container.decodeIfPresentIgnoringCase(BooleanState.self, forKey: .ignitionState)
            self.battery = try container.decodeIfPresentIgnoringCase(Battery.self, forKey: .battery)
            self.heading = try container.decodeIfPresentIgnoringCase(Heading.self, forKey: .heading)
            self.location = try container.decodeIfPresentIgnoringCase(Location.self, forKey: .location)
            self.accidentState = try container.decodeIfPresentIgnoringCase(BooleanState.self, forKey: .accidentState)
            self.vinDetails = try container.decodeIfPresentIgnoringCase(VinDetails.self, forKey: .vinDetails)
            self.towState = try container.decodeIfPresentIgnoringCase(BooleanState.self, forKey: .towState)
            self.parkedState = try container.decodeIfPresentIgnoringCase(BooleanState.self, forKey: .parkedState)
            self.ownerGroups = try container.decodeIfPresentIgnoringCase([String].self, forKey: .ownerGroups) ?? []
            ...
            self.engineOil = try container.decodeIfPresentIgnoringCase(EngineOil.self, forKey: .engineOil)
            self.tirePressure = try container.decodeIfPresentIgnoringCase(TirePressure.self, forKey: .tirePressure)
            self.predictiveMaintenance = try container.decodeIfPresentIgnoringCase(PredictiveMaintenance.self, forKey: .predictiveMaintenance)
        }
        catch {
            debugPrint(error)
            throw error
