...
public class ClientEnvironment : NSObject {
    ...
    private static let ApiEndpointFormat : String = "https://%@na-api-stagingslot.moj.io/v2/"
    private static let ApiV1EndpointFormat : String = "https://%@na-api-stagingslot.moj.io/v1/"
    private static let PushApnsEndpointFormat : String = "https://%@na-push-stagingslot.moj.io/v2/"
    private static let PushWSEndpointFormat : String = "wss://%@na-api-stagingslot.moj.io/v2/"
    private static let MyMojioEndpointFormat : String = "https://%@my.moj.io/"
    private static let AccountsEndpointFormat : String = "https://%@identity-stagingslot.moj.io/"
